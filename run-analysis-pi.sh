...
/usr/bin/mysqldump --defaults-extra-file=/home/pi/my-pi.cnf team195_scouting > /home/pi/DB-backups/dbdump.sql
/bin/sleep 1
...
/usr/bin/mysql --defaults-extra-file=/home/pi/my-aws.cnf -h $db team195_scouting < /home/pi/DB-backups/dbdump.sql
echo ''
